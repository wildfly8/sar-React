...
const RatingEnforcementTable = ({ data }) => {
  const columns = [{
    ...
    dataField: PX_TARGET_HEADERS.isNew,
    text: 'isNew',
    hidden: true
  }, {
    ...
    dataField: PX_TARGET_HEADERS.systemRating,
    text: 'systemRating',
    formatter: (cell) => (
    ...
    dataField: PX_TARGET_HEADERS.enforcedRating,
    text: 'enforcedRating',
    formatter: (cell) => (
      cell? cell.toUpperCase() : null
    ),
    ...
    dataField: PX_TARGET_HEADERS.enforcedReason,
    text: 'enforcedReason',
    headerStyle: {
      paddingTop: '0px',
      paddingBottom: '0px'
